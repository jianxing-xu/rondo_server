...
import cn.xu.roundo.entity.vo.LrcLine;
import cn.xu.roundo.entity.vo.PassUserInfoVo;
...
import cn.xu.roundo.utils.KwUtils;
...
public class SongController extends BaseController {
    ...
    public String delMySong(@RequestParam("mid") @NotBlank Integer mid,
                            @RequestParam("room_id") @NotBlank Integer roomId,
     ...
     */
    @PostMapping("/fav")
    public String favMySong(@RequestParam("mid") @NotBlank Integer mid,
                            @UserId Integer userId) {
        ...
        //TODO: sendWebsocketMsg 歌曲收藏成功系统消息通知
        return "收藏成功";
    }
    ...
    public Response addSong(@RequestParam("mid") @NotNull Long mid,
        ...
        Boolean isBan = redis.getCacheObject(Constants.SongDown(roomId, userId));
        if (isBan != null && isBan) throw new ApiException(ErrorEnum.BAN_USER_ADD_SONG);
        ...
        // TODO: sendWebsocketMsg 发送点歌消息到房间
//        $msg = [
